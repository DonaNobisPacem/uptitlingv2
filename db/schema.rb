...
ActiveRecord::Schema.define(version: 20150602031023) do

  create_table "landholdings", force: :cascade do |t|
  ...
  add_index "landholdings", ["university_id"], name: "index_landholdings_on_university_id", using: :btree
  ...
  add_foreign_key "landholdings", "universities"
end
